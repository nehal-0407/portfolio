  ...
  return (
    <section id="contact" className="section-pad py-20 sm:py-28 border-t border-line dark:border-line-dark">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-px bg-line dark:bg-line-dark border border-line dark:border-line-dark rounded-lg overflow-hidden">
          {CONTACTS.map((c) => (
            <a
              key={c.label}
              href={c.href}
