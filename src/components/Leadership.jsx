        ...
        <Reveal>
          ...
          <ul className="space-y-4">
            {LEADERSHIP.map((item) => (
              <li
                key={item.role}
                className="border-l-2 border-accent dark:border-accent-light pl-4 hover:pl-5 transition-[padding] duration-300"
              >
        ...
        <Reveal delay={100}>
          ...
          <ul className="space-y-4">
            {CERTS.map((c) => (
              <li
                key={c.name}
                className="border-l-2 border-line dark:border-line-dark pl-4 hover:pl-5 hover:border-accent dark:hover:border-accent-light transition-all duration-300"
              >
